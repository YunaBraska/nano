...
//    }
    ...
    void sendEvent_Sync() throws InterruptedException {
        ...
        nano.sendEvent(TEST_EVENT, nano.newContext(this.getClass()), 11111111, response -> latch1.countDown(), false);
        ...
        nano.sendEvent(TEST_EVENT, nano.newContext(this.getClass()), 22222222, response -> latch2.countDown(), false);
        ...
        nano.sendEvent(TEST_EVENT, nano.newContext(this.getClass()), 33333333, response -> latch3.countDown(), true);
    ...
    void sendEventWithEventExecutionException_shouldNotInterrupt() {
        ...
        assertThat(context).hasSize(2).containsKeys(CONTEXT_TRACE_ID_KEY, CONTEXT_CLASS_KEY);
