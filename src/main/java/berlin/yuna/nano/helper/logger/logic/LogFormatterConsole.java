...
import static berlin.yuna.nano.helper.logger.logic.NanoLogger.MAX_LOG_NAME_LENGTH;
import static berlin.yuna.nano.helper.logger.model.LogLevel.nanoLogLevelOf;
