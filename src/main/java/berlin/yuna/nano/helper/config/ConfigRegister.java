package berlin.yuna.nano.helper.config;

import berlin.yuna.nano.core.NanoBase;
import berlin.yuna.nano.helper.NanoUtils;

import static berlin.yuna.nano.core.NanoBase.CONFIG_KEYS;
import static java.util.Optional.ofNullable;

/**
 * Utility class for registering and retrieving configuration descriptions.
 * <p>
 * This class is typically used for {@link berlin.yuna.nano.core.model.Service} or custom functions to display
...
public class ConfigRegister {
    ...
    public static String registerConfig(final String key, final String description) {
        return ofNullable(key)
            ...
            .map(name -> {
                CONFIG_KEYS.computeIfAbsent(name, k -> description == null ? "" : description);
                return name;
            })
            .orElse(null);
    }
